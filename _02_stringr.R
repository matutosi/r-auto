  # tidyverseのインストール
  # 02_01_stringr-install.R
install.packages("tidyverse") # stringrを含むパッケージ群をインストール
  # install.packages("stringr") # 単独でのインストール

  # tidyverseの呼び出し
  # 02_02_stringr-library.R
  # あとでdplyrも使うので，tidyverseを呼び出し
library(tidyverse) # tidyverseはstringrを含む
  # library(stringr) # 単独で呼び出すとき

  # 文字列の結合
  # 02_03_stringr-str-c.R
str_neko <- 
  c("吾輩は猫である。", "名前はまだない。", 
...
str_remove_all(str_neko, "[あ-ん]")
  ...
  # str_remove()の中身
  # 02_08_stringr-str-remove-fun.R
str_remove # 関数の中身

  # 文字列の検索
  # 02_09_stringr-str-brothers.R
...
str_sub(str_123, 1:3, 3:5)           # 前から順に1-3，2-4，3-5を抽出
  ...
  # stringrのその他の関数
  # 02_16_stringr-others.R
pattern <- "[a-z]+|[あ-ん]+" # アルファベットの小文字かひらがなが1つ以上

  # マッチ箇所の明示
str_view_all(str_neko, pattern)
