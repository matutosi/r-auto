...
library(chatgpt)
  ...
  # APIキーの設定
  # 14_03_ai-chatgpt-api-key.R
Sys.setenv(OPENAI_API_KEY = "xx-xxxxxxxxxxxxxxxxxxxxxxxx")

  # ChatGPTへの質問
  # 14_04_ai-chatgpt-ask-chatgpt.R
  # (ChatGPTからの回答を読みやすく調整済み，以下同様)
ask_chatgpt("Rの特徴を教えてください．")

  # セッションのリセット
  # 14_05_ai-chatgpt-ask-reset-chat-session.R
...
explain_code(code)
  ...
  # 日本語でのコードの説明
  # 14_07_ai-chatgpt-explain-code-jp.R
...
gemini_para <- function(prompt, temperature){
  ...
  # 各種パッケージの呼び出し
  # 14_23_ai-gemini-library-others.R
library(httr)
library(jsonlite)
library(base64enc)
