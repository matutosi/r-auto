...
str_remove_all(str_neko, "[あ-ん]")
  ...
  # str_remove()の中身
  # 03_10_string-str-remove-fun.R
str_remove # 関数の中身

  # 文字列の検索
  # 03_11_string-str-brothers.R
...
str_squish("  a   b  c  ") # 重複も除去
  ...
  # diffrのインストールと呼び出し
  # 03_18_string-diffr-install.R
install.packages("diffr")
library(diffr)

  # 文章の比較
  # 03_19_string-compare-diffr.R
f1 <- fs::file_temp()
f2 <- fs::file_temp()
