...
df <- tibble::tibble(
  equal_3 = val,
  colourScale = val, databar = val, top5 = val, bottom3 = val, 
...
page_break <- function(wb, sheet, type = "row", col_name){
  ...
  # 学年ごとに改ページを設定する
  # 09_48_excel-page-breaks-grade.R
wb_breaks <- wb
...
add_page_break <- function(wb, sheet, col_name, page_size = 30){
  ...
  # 09_51_excel-page-compare-add-breaks.R
