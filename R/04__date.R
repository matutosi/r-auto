...
paste(dates, collapse = "◆") |> #
  ...
  # ymd()は和暦に対応していない
  # 04_18_date-ymd-not-work.R
c("令和06年01月01日", "2024-01-01") |>
  ymd()
