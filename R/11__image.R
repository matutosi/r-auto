...
image_info(imgs[1])
  ...
  # 画像の高さ
  # 11_09_image-info-details.R
image_info(imgs)$height

  # 画像の変換
  # 11_10_image-convert.R
...
plot(annotated_25)
  ...
  # 横方向への結合
  # 11_19_image-append-horizontal.R
image_append(imgs[1:24]) |>
  plot() # 横方向

  # 縦方向への結合
  # 11_20_image-append-vertical.R
...
path |>
  ...
  # 11_33_image-binarization-package.R
...
click_locate_image <- function(img, n = 2){
  ...
  # 画像をクリックした位置の取得
  # 11_42_image-click-locate-image.R
pos <- 
  imgs[25] |>
  image_scale("1200") |>
